<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="MYPROJECT.Admin.Product" %>
                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-4 col-lg-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                            placeholder="Enter Bike Name"></asp:TextBox>
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control"
                                                            placeholder="Enter Bike Description" TextMode="MultiLine"></asp:TextBox>
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control"
                                                            placeholder="Enter Bike Price"></asp:TextBox>
                                                 ...
                                                 <div>
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control"
                                                            placeholder="Enter Bike Quantity"></asp:TextBox>
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="CategoryId" AppendDataBoundItems="true"><asp:ListItem Value="0">Select Category</asp:ListItem></asp:DropDownList>
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                                <h4 class="sub-title">Bike Lists</h4>
                                                ...
                                                <div class="card-block table-border-style">
                                                    <div class="table-responsive">
                                                        <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand" OnItemDataBound="rProduct_ItemDataBound" >
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                   ...
                                                                   <td> 
                                                                       <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CssClass="badge badge-primary" CausesValidation="false" CommandArgument='<%# Eval("ProductId")  %>' CommandName="edit"><i class="ti-pencil"></i></asp:LinkButton>
                                                                       <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CssClass="badge badge-primary" CommandArgument='<%# Eval("ProductId")  %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete this category?');" CausesValidation="false"><i class="ti-trash"></i></asp:LinkButton>
                                                                   </td>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" DeleteCommand="DELETE FROM [Products] WHERE [ProductId] = @ProductId" InsertCommand="INSERT INTO [Products] ([Name ], [Description], [Price], [Quantity], [ImageUrl], [CategoryId], [IsActive], [CreatedDate]) VALUES (@Name_, @Description, @Price, @Quantity, @ImageUrl, @CategoryId, @IsActive, @CreatedDate)" ProviderName="<%$ ConnectionStrings:cs.ProviderName %>" SelectCommand="SELECT * FROM [Products]" UpdateCommand="UPDATE [Products] SET [Name ] = @Name_, [Description] = @Description, [Price] = @Price, [Quantity] = @Quantity, [ImageUrl] = @ImageUrl, [CategoryId] = @CategoryId, [IsActive] = @IsActive, [CreatedDate] = @CreatedDate WHERE [ProductId] = @ProductId">
                                                            <DeleteParameters>
                                                                <asp:Parameter Name="ProductId" Type="Int32" />
                                                            </DeleteParameters>
                                                            <InsertParameters>
                                                                <asp:Parameter Name="Name_" Type="String" />
