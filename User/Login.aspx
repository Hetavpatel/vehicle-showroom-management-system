<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MYPROJECT.User.Login" %>
                    ...
                    <div class="form_container">
                        ...
                        <div class="btn-box">
                            ...
                            <span class="pl-3 text-info">
                              ...
                              <span class="pl-3 text-info">
                                Forget Password? <a href="ForgetPassword.aspx" class="badge badge-info">Click here..</a>
                            </span>
                        </div>
                    </div>
                </div>
